...
public class RunMummySignUp extends Precondition {
	...
	public void stage_web_aurofit_RUNMUMMYRUN_SignUp_Checkout_Subscribe() throws InterruptedException {
			
		test=extent.createTest("RUNMUMMYRUN- Valid SignUp do the payment avail offer");
	    test.log(Status.INFO, "RUNMUMMYRUN- Valid SignUp do the payment avail offer valid SignUp test script started executing");
			...
			test.pass("Entered CouponCode -RMR20");
			ACP.clickApplyButton();
			test.pass("Clicked Apply Button");
			ACP.verifyCouponCodeApplied();
			test.pass("Verified Coupon Code");
			ACP.verifyAvailedDiscountRMR20PriceText("24.33");
			test.pass("ensured discount availed by coupon code RMR20");
			Thread.sleep(2000);
			...
			AssertJUnit.assertEquals(actualurl, "https://stage-web.auro.fit/coworking-signup/thank-you");
			test.pass("Test Script Passed");
	}
	
	//valid signup with already registered email
	        @Test(priority = 02,invocationCount = 01)
			public void stage_web_aurofit_RUNMUMMYRUN_SignUp_with_Already_Registed_Email() throws InterruptedException {
					
			    	test=extent.createTest("RUNMUMMYRUN-valid signup with already registered email");
				    test.log(Status.INFO, "RUNMUMMYRUN-valid signup with already registered email test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
		    ...
		    public void stage_web_aurofit_RUNMUMMYRUN_Login_With_Valid_Credentials() throws InterruptedException {
				
		    	test=extent.createTest("RUNMUMMYRUN-Valid Login");
			    test.log(Status.INFO, "RUNMUMMYRUN-Valid Login test script started executing");
			    Auro_Home_Page AH=new Auro_Home_Page(driver);
				AH.clickGet30DaysFreeButton();
				test.pass("clicked Get30DaysFree Button");
				//AH.clickstartFreeTrial();
		  ...
		  //Login with  valid Email and invalid Password and verify the error message
	         @Test(priority = 04,invocationCount = 01)
	 		 public void stage_web_aurofit_RUNMUMMYRUN_LOGIN_VALID_EMAIL_INVALID_PASSWORD() throws InterruptedException {
				
				    test=extent.createTest("RUNMUMMYRUN- valid Email and invalid Password and verify the error message");
				    test.log(Status.INFO, "RUNMUMMYRUN- valid Email and invalid Password and verify the error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
	 		...
	 		//Login Entering Invalid Email and Valid Password and verify the error message
				...
				public void stage_web_aurofit_RUNMUMMYRUN_LOGIN_INVALID_EMAIL__VALIDPASSWORD() throws InterruptedException {
					
					test=extent.createTest("RUNMUMMYRUN-Login Entering Invalid Email and Valid Password and verify the error message");
				    test.log(Status.INFO, "RUNMUMMYRUN-Login Entering Invalid Email and Valid Password and verify the error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_RUNMUMMYRUN_LOGIN_UNREGISTEREDMAIL() throws InterruptedException {
					
					test=extent.createTest("RUNMUMMYRUN-Login Entering Unregistered Mail and check the error message");
				    test.log(Status.INFO, "RUNMUMMYRUN-Login Entering Unregistered Mail and check the error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
	            ...
	            @Test(priority = 07,invocationCount = 01)
				public void stage_web_aurofit_RUNMUMMYRUN_Dothe_Payment_Entering_Expired_Card_Credentials() throws InterruptedException {
					
					test=extent.createTest("RUNMUMMYRUN -Enter the Expired Card Credentials And verify \"Your card has expired.\" Error Message");
				    test.log(Status.INFO, "RUNMUMMYRUN -Enter the Expired Card Credentials And verify \"Your card has expired.\" Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();          
				...
				public void stage_web_aurofit_RUNMUMMYRUN_Dothe_Payment_Entering_Credentials_Incorrect_Security_Code() throws InterruptedException {
					
					test=extent.createTest("RUNMUMMYRUN- Enter the Card Credentials And verify \"Your card's security code is incorrect.\" Error Message");
				    test.log(Status.INFO, "RUNMUMMYRUN- Enter the Card Credentials And verify \"Your card's security code is incorrect.\" Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_RUNMUMMYRUN_Dothe_Payment_Entering_Credentials_Error_while_processing_the_card() throws InterruptedException {
					
					test=extent.createTest("RUNMUMMYRUN- Enter the  Card Credentials And verify \"An error occurred while processing your card. Try again in a little bit.\" Error Message while processing the Card");
				    test.log(Status.INFO, "RUNMUMMYRUN- Enter the  Card Credentials And verify \"An error occurred while processing your card. Try again in a little bit.\" Error Message while processing the Card test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
	            ...
	            public void stage_web_aurofit_RUNMUMMYRUN_Dothe_Payment_Entering_Credentials_Invalid_CardNumber_ErrorMessage() throws InterruptedException {
							
					test=extent.createTest("RUNMUMMYRUN- Enter the  Card Credentials And verify  \"Your card number is invalid.\"Error Message");
				    test.log(Status.INFO, "RUNMUMMYRUN- Enter the  Card Credentials And verify  \"Your card number is invalid.\"Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
	            ...
	            public void stage_web_aurofit_RUNMUMMYRUN_LoseWeight_Beginner_Spin_Availoffer_Dothe_Payment_Entering_IncompleteCardNumber_Verify_ErrorMessage() throws InterruptedException {
					
					test=extent.createTest("RUNMUMMYRUN- Enter incomplete card number and verify \"Your card number is incomplete.\" Error message");
				    test.log(Status.INFO, "RUNMUMMYRUN- Enter incomplete card number and verify \"Your card number is incomplete.\" Error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
	            ...
	            public void stage_web_aurofit_RUNMUMMYRUN_Dothe_Payment_Incomplete_ExpiryDate_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("RUNMUMMYRUN- Enter incomplete ExpiryDate and Verify \"Your card's expiration date is incomplete.\" Error Message ");
				    test.log(Status.INFO, "RUNMUMMYRUN- Enter incomplete ExpiryDate and Verify \"Your card's expiration date is incomplete.\" Error Message  test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
	            ...
	            public void stage_web_aurofit_RUNMUMMYRUN_LoseWeight_Beginner_Spin_Availoffer_Dothe_Payment_Incomplete_CvC_Code_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("RUNMUMMYRUN-Enter incomplete CvC Code and Verify \"Your card's security code is incomplete.\" Error Message ");
				    test.log(Status.INFO, "RUNMUMMYRUN-Enter incomplete CvC Code and Verify \"Your card's security code is incomplete.\" Error Message  test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
	            ...
	            public void stage_web_aurofit_RUNMUMMYRUN_Dothe_Payment_Incomplete_ZIP_Code_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("RUNMUMMYRUN-Enter incomplete ZIP Code and Verify \"Your postal code is incomplete.\" Error Message");
				    test.log(Status.INFO, "RUNMUMMYRUN-Enter incomplete ZIP Code and Verify \"Your postal code is incomplete.\" Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
	            ...
	            public void stage_web_aurofit_RUNMUMMYRUN_Dothe_Payment_Enter_DeadCardCredentials_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("RUNMUMMYRUN-Enter Dead Card and verify 'Your card's expiration year is in the past.' Error Message");
				    test.log(Status.INFO, "RUNMUMMYRUN-Enter Dead Card and verify 'Your card's expiration year is in the past.' Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
	            ...
	            public void stage_web_aurofit_RUNMUMMYRUN__LOGIN_UNSUBSCRIBED_USER() throws InterruptedException {
						
				    	test=extent.createTest("RUNMUMMYRUN-Login as Unsubscribed user");
					    test.log(Status.INFO, "RUNMUMMYRUN-Login as Unsubscribed user test script started executing");
					    Auro_Home_Page AH=new Auro_Home_Page(driver);
						AH.clickGet30DaysFreeButton();
						test.pass("clicked Get30DaysFree Button");
						//AH.clickstartFreeTrial();
						...
						String actualurl = driver.getCurrentUrl();
						System.out.println(actualurl);
						AssertJUnit.assertEquals(actualurl, "https://stage-web.auro.fit/coworking-signup?campaign=promo#checkout");
						test.pass("Test Script Passed");
	            ...
	            public void stage_web_RUNMUMMYRUN_ForgotPassword() throws InterruptedException {
	            ...
	            public void stage_web_aurofit_RUNMUMMYRUN_verify_Enter_Valid_Email_Error_Message() throws InterruptedException {
	            ...
	            public void stage_web_aurofit_RUNMUMMYRUN_verify_Enter_Password_Error_Message() throws InterruptedException {
	         ...
	         // Enter invalid coupon code and verify the error message
				...
				public void stage_web_aurofit_RUNMUMMYRUN_SignUp_Enter_Invalid_CouponCode() throws InterruptedException {
						
				    	test=extent.createTest("RUNMUMMYRUN-Main Page Valid SignUp do the payment avail offer");
					    test.log(Status.INFO, "RUNMUMMYRUN-Main Page Valid SignUp do the payment avail offer valid SignUp test script started executing");
					    Auro_Home_Page AH=new Auro_Home_Page(driver);
						AH.clickGet30DaysFreeButton();
						test.pass("clicked Get30DaysFree Button");
						//AH.clickstartFreeTrial();
