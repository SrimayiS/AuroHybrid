...
public class Stage_web_newMem_50per_Off extends Precondition {
	...
	public void enterAlreadyRegisteredmailid_and_verify_errormessage() throws InterruptedException {
		test=extent.createTest("new Mem_50per_Off-Enter already registered email id and verify-You cannot avail this offer as you are a subscribed user. Please contact support@auro.fit for further assistance.error message");
	    test.log(Status.INFO, "new Mem_50per_Off-Enter already registered email id and verify-You cannot avail this offer as you are a subscribed user. Please contact support@auro.fit for further assistance. Script started executing");
	...
	//verify 50 percentage Off
			@Test(priority = 2,invocationCount = 01)
			public void verify25perOff() throws InterruptedException {
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				test=extent.createTest("new Mem_50per_Off-verify 'Get 50% off premium fitness & wellness' text.");
			    test.log(Status.INFO, "new Mem_50per_Off-verify 'Get 50% off premium fitness & wellness' text. Script started executing.");
				
				//ANM.moveToGetAuroPremium();
				ANM.verify50PerOffText("Get 50% off premium fitness & wellness");
				test.pass("verified -'Get 50% off premium fitness & wellness' text.");
			}
	...
	public void enternotRegisteredmailid_and_verify_errormessage() {
		test=extent.createTest("new Mem_50per_Off-Enter Un  registered email id and verify-You're not a registered user. Please provide a password for registering your account.error message");
	    test.log(Status.INFO, "new Mem_50per_Off-Enter Un  registered email id and verify-You're not a registered user. Please provide a password for registering your account.error message. Script started executing");
		Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
		ANM.moveToGetAuroPremium();
		test.pass("Scrolled to Get Auro Premium");
	...
	//verify error message  "Please enter a valid email address."
		...
		public void enterInValidEmailAddress_and_verify_errormessage() {
			test=extent.createTest("new Mem_50per_Off-Enter In valid email id and verify-'Please enter a valid email address'.error message");
		    test.log(Status.INFO, "new Mem_50per_Off-Enter In valid email id and verify-'Please enter a valid email address'.error message. Script started executing");
			Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
			ANM.moveToGetAuroPremium();
			test.pass("Scrolled to Get Auro Premium");
			ANM.setMailid(System.currentTimeMillis()+"gmail.com");
		...
		//enter NO email address  and verify error message "This field is required."
				...
				public void enterN0EmailAddress_and_verify_errormessage() {
					test=extent.createTest("new Mem_50per_Off-Enter no Email id and verify 'This field is required.' error message");
				    test.log(Status.INFO, "new Mem_50per_Off-Enter no Email id and verify 'This field is required.' error message. Script started executing");
					Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
					ANM.moveToGetAuroPremium();
					test.pass("Scrolled to Get Auro Premium");
					ANM.clickGetAuroPremium();
				...
				public void enterNOpassword_and_verify_errormessage() {
					test=extent.createTest("new Mem_50per_Off-Enter no Password and verify 'This field is required.' error message");
				    test.log(Status.INFO, "new Mem_50per_Off-Enter no Password and verify 'This field is required.' error message. Script started executing");
					Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
					ANM.moveToGetAuroPremium();
					test.pass("Scrolled to Get Auro Premium");
					ANM.setMailid(System.currentTimeMillis()+"@gmail.com");
					test.pass("Entered valid Email id");
					ANM.clickGetAuroPremium();
					test.pass("Clicked  Get Auro Premium Button");
			  ...
			  @Test(priority = 7,invocationCount = 01)
		   	public void validRegister_Payment_new_member() throws InterruptedException {
				...
				test=extent.createTest("new Mem_50per_Off-Enter Valid Credentials Make payment and avail 50% OFF");
				test.log(Status.INFO, "new Mem_50per_Off-Enter Valid Credentials Make payment and avail 50% OFF. Script started executing");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
				...
				Assert.assertEquals(actualurl, "https://stage-web.auro.fit/50-off/signup-success");
	...
	//Enter the Expired Card Credentials And verify "Your card has expired." Error Message
			...
			public void new_Member_enterEmail_password_Dothe_Payment_Entering_Expired_Card_Credentials() throws InterruptedException {
				test=extent.createTest("new Mem_50per_Off-Enter Expired Card credentials and verify -'Your card has expired.' Error message");
				test.log(Status.INFO, "new Mem_50per_Off-Enter Expired Card credentials and verify -'Your card has expired.' Error message. Script started executing");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
			...
			public void new_Member_enterEmail_password_othe_Payment_Entering_Credentials_Incorrect_Security_Code() throws InterruptedException {
				test=extent.createTest("new Mem_50per_Off-Enter  Card credentials and verify -'Your card's security code is incorrect.' Error message");
				test.log(Status.INFO, "new Mem_50per_Off-Enter Expired Card credentials and verify -'Your card's security code is incorrect.' Error message. Script started executing");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
			...
			@Test(priority = 0,invocationCount = 01)
			public void new_Member_enterEmail_password_Dothe_Payment_Entering_Credentials_Invalid_CardNumber_ErrorMessage() throws InterruptedException {
				test=extent.createTest("new Mem_50per_Off-Enter  Card credentials and verify -'Your card number is invalid.' Error message");
				test.log(Status.INFO, "new Mem_50per_Off-Enter Expired Card credentials and verify -'Your card number is invalid.' Error message. Script started executing");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
			...
			public void new_Member_enterEmail_password_Dothe_Payment_Entering_Credentials_Error_while_processing_the_card1() throws InterruptedException {
				...
				test=extent.createTest("new Mem_50per_Off-Enter  Card credentials and verify -'An error occurred while processing your card. Try again in a little bit.' Error message");
				test.log(Status.INFO, "new Mem_50per_Off-Enter Expired Card credentials and verify -'An error occurred while processing your card. Try again in a little bit.' Error message. Script started executing");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
			...
			public void new_Member_enterEmail_password_Dothe_Payment_Incomplete_ZIP_Code_verifyErrorMessage() throws InterruptedException {
				...
				test=extent.createTest("new Mem_50per_Off-Enter  In complete ZIP Code  and verify -'Your postal code is incomplete.' Error message");
				test.log(Status.INFO, "new Mem_50per_Off-Enter  In complete ZIP Code  and verify -'Your postal code is incomplete.' Error message. Script started executing");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
            ...
            public void new_Member_enterEmail_password_Dothe_Payment_Entering_IncompleteCardNumber_Verify_ErrorMessage() throws InterruptedException {
				...
				test=extent.createTest("new Mem_50per_Off-Enter  In complete Card number  and verify -'Your card number is incomplete.' Error message");
				test.log(Status.INFO, "new Mem_50per_Off-Enter   In complete Card number  and verify -'Your card number is incomplete.' Error message. Script started executing");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
			...
			@Test(priority = 14,invocationCount = 001)
			public void new_Member_enterEmail_password_Dothe_Payment_Incomplete_CvC_Code_verifyErrorMessage() throws InterruptedException {
				test=extent.createTest("new Mem_50per_Off-Enter  In complete Security code  and verify -'Your card's security code is incomplete.' Error message");
				test.log(Status.INFO, "new Mem_50per_Off-Enter   In complete Security code  and verify -'Your card's security code is incomplete.' Error message. Script started executing");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
			...
			@Test(priority = 15,invocationCount = 001)
			public void new_Member_enterEmail_password_Dothe_Payment_Incomplete_Expiredate_verifyErrorMessage() throws InterruptedException {
				test=extent.createTest("new Mem_50per_Off-Enter  In complete Expiry Date  and verify -'Your card's expiration date is incomplete.' Error message");
				test.log(Status.INFO, "new Mem_50per_Off-Enter   In complete Expiry Date   and verify -'Your card's expiration date is incomplete.' Error message. Script started executing");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
			...
			//Enter past expiration date and Verify "Your card's expiration year is in the past." Error Message 
			@Test(priority = 16,invocationCount = 001)
			public void new_Member_enterEmail_password_Dothe_Payment__ExpiredateInThePast_verifyErrorMessage() throws InterruptedException {
				...
				test=extent.createTest("new Mem_50per_Off-Enter past expiration date and Verify \"Your card's expiration year is in the past.\" Error Message ");
				test.log(Status.INFO, "new Mem_50per_Off-Enter past expiration date and Verify \"Your card's expiration year is in the past.\" Error Message ");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
			...
			@Test(priority = 17,invocationCount = 001)
              public void new_Member_enterEmail_password_Dothe_Payment__ExpirationYearIsInvalid_verifyErrorMessage() throws InterruptedException  {
				...
				test=extent.createTest("new Mem_50per_Off-Enter In valid expiration date and Verify \"Your card's expiration year is invalid.\" Error Message ");
				test.log(Status.INFO, "new Mem_50per_Off-Enter In valid expiration date and Verify \"Your card's expiration year is invalid.\" Error Message ");
				Auro_new_member_offer ANM = new Auro_new_member_offer(driver);
				ANM.moveToGetAuroPremium();
				test.pass("Scrolled to Get Auro Premium");
				Thread.sleep(2000);
