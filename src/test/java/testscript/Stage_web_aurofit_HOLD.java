...
public class Stage_web_aurofit_HOLD extends Precondition {

	@Test(priority = 1,invocationCount = 01)
	public void stage_web_aurofit_Hold_SignUp_enterCouponcode_Checkout_Subscribe() throws InterruptedException {
			
		test=extent.createTest("Hold- Valid SignUp do the payment avail offer");
	    test.log(Status.INFO, "Hold- Valid SignUp do the payment avail offer valid SignUp test script started executing");
			...
			ACP.verifyCouponCodeHOLDAPPapplied("27.37");
			test.pass("Verified Coupon Code applied and discount availed");
			Thread.sleep(2000);
			...
			Assert.assertEquals(actualurl, "https://stage-web.auro.fit/hold-signup/thank-you");
			test.pass("Test Script Passed");
	}
	
	//valid signup with already registered email
			@Test(priority = 2,invocationCount = 01)
			public void stage_web_aurofit_Hold_SignUp_with_Already_Registed_Email() throws InterruptedException {
		    ...
		    public void stage_web_aurofit_HOLD_Login_With_Valid_Credentials() throws InterruptedException {
		  ...
		  //Login with  valid Email and invalid Password and verify the error message
		     ...
		     public void stage_web_aurofit_HOLD_LOGIN_VALID_EMAIL_INVALID_PASSWORD() throws InterruptedException {
				
				    test=extent.createTest("Hold- valid Email and invalid Password and verify the error message");
				    test.log(Status.INFO, "Hold- valid Email and invalid Password and verify the error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
			...
			//Login Entering Invalid Email and Valid Password and verify the error message
			    ...
			    public void stage_web_aurofit_HOLD_LOGIN_INVALID_EMAIL__VALIDPASSWORD() throws InterruptedException {
					
					test=extent.createTest("Hold-Login Entering Invalid Email and Valid Password and verify the error message");
				    test.log(Status.INFO, "Hold-Login Entering Invalid Email and Valid Password and verify the error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
			    ...
			    public void stage_web_aurofit_HOLD_LOGIN_UNREGISTEREDMAIL() throws InterruptedException {
					
					test=extent.createTest("HOLD-Login Entering Unregistered Mail and check the error message");
				    test.log(Status.INFO, "HOLD-Login Entering Unregistered Mail and check the error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_HOLD_Dothe_Payment_Entering_Expired_Card_Credentials() throws InterruptedException {
					
					test=extent.createTest("HOLD-Enter the Expired Card Credentials And verify \"Your card has expired.\" Error Message");
				    test.log(Status.INFO, "HOLD-Enter the Expired Card Credentials And verify \"Your card has expired.\" Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_HOLD_Dothe_Payment_Entering_Credentials_Incorrect_Security_Code() throws InterruptedException {
					
					test=extent.createTest("HOLD-Enter the Card Credentials And verify \"Your card's security code is incorrect.\" Error Message");
				    test.log(Status.INFO, "HOLD-Enter the Card Credentials And verify \"Your card's security code is incorrect.\" Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_HOLD_Dothe_Payment_Entering_Credentials_Error_while_processing_the_card() throws InterruptedException {
					
					test=extent.createTest("HOLD-Enter the  Card Credentials And verify \"An error occurred while processing your card. Try again in a little bit.\" Error Message while processing the Card");
				    test.log(Status.INFO, "HOLD-Enter the  Card Credentials And verify \"An error occurred while processing your card. Try again in a little bit.\" Error Message while processing the Card test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				@Test(priority = 10,invocationCount = 01)
					public void stage_web_aurofit_HOLD_Dothe_Payment_Entering_Credentials_Invalid_CardNumber_ErrorMessage() throws InterruptedException {
							
					test=extent.createTest("Hold-Enter the  Card Credentials And verify  \"Your card number is invalid.\"Error Message");
				    test.log(Status.INFO, "Hold-Enter the  Card Credentials And verify  \"Your card number is invalid.\"Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
          ...
          public void stage_web_aurofit_HOLD_LoseWeight_Beginner_Spin_Availoffer_Dothe_Payment_Entering_IncompleteCardNumber_Verify_ErrorMessage() throws InterruptedException {
					
					test=extent.createTest("Hold-Enter incomplete card number and verify \"Your card number is incomplete.\" Error message");
				    test.log(Status.INFO, "Hold-Enter incomplete card number and verify \"Your card number is incomplete.\" Error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_HOLD_Dothe_Payment_Incomplete_ExpiryDate_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("Hold-Enter incomplete ExpiryDate and Verify \"Your card's expiration date is incomplete.\" Error Message ");
				    test.log(Status.INFO, "Hold-Enter incomplete ExpiryDate and Verify \"Your card's expiration date is incomplete.\" Error Message  test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_HOLD_LoseWeight_Beginner_Spin_Availoffer_Dothe_Payment_Incomplete_CvC_Code_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("HOLD-Enter incomplete CvC Code and Verify \"Your card's security code is incomplete.\" Error Message ");
				    test.log(Status.INFO, "HOLD-Enter incomplete CvC Code and Verify \"Your card's security code is incomplete.\" Error Message  test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_Hold_Dothe_Payment_Incomplete_ZIP_Code_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("Hold-Enter incomplete ZIP Code and Verify \"Your postal code is incomplete.\" Error Message");
				    test.log(Status.INFO, "Hold-Enter incomplete ZIP Code and Verify \"Your postal code is incomplete.\" Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_HOLD_Dothe_Payment_Enter_DeadCardCredentials_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("HOLD-Enter Dead Card and verify 'Your card's expiration year is in the past.' Error Message");
				    test.log(Status.INFO, "HOLD-Enter Dead Card and verify 'Your card's expiration year is in the past.' Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_HOLD_SignUp_Enter_Invalid_CouponCode() throws InterruptedException {
						
				    	test=extent.createTest("Hold-Main Page Valid SignUp do the payment avail offer");
					    test.log(Status.INFO, "Hold-Main Page Valid SignUp do the payment avail offer valid SignUp test script started executing");
					    Auro_Home_Page AH=new Auro_Home_Page(driver);
						AH.clickGet30DaysFreeButton();
						test.pass("clicked Get30DaysFree Button");
						//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_HOLD__SIGNED_UP_UNSUBSCRIBED_USER() throws InterruptedException {
						...
						String actualurl = driver.getCurrentUrl();
						System.out.println(actualurl);
						Assert.assertEquals(actualurl, "https://stage-web.auro.fit/hold-signup/#checkout");
						test.pass("Test Script Passed");
				...
				public void stage_web_HOLD_ForgotPassword() throws InterruptedException {
						
				    	test=extent.createTest("HOLD-Login as Unsubscribed user");
					    test.log(Status.INFO, "HOLD-Login as Unsubscribed user test script started executing");
					    Auro_Home_Page AH=new Auro_Home_Page(driver);
						AH.clickGet30DaysFreeButton();
						test.pass("clicked Get30DaysFree Button");
						//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_HOLD_verify_Enter_Valid_Email_Error_Message() throws InterruptedException {
				...
				public void stage_web_aurofit_HOLD_verify_Enter_Password_Error_Message() throws InterruptedException {
