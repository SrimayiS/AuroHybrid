...
public class Stage_web_aurofit_SNATCH extends Precondition {

	@Test(priority = 1,invocationCount = 01)
	public void stage_web_aurofit_SNATCH_SignUp_enterCouponcode_Checkout_Subscribe() throws InterruptedException {
			
		test=extent.createTest("SNATCH- Valid SignUp do the payment avail offer");
	    test.log(Status.INFO, "SNATCH- Valid SignUp do the payment avail offer valid SignUp test script started executing");
			...
			ACP.enterCouponCode("SNATCH");
			test.pass("Entered CouponCode -SNATCH");
			...
			Assert.assertEquals(actualurl, "https://stage-web.auro.fit/snatch-signup/thank-you");
			test.pass("Test Script Passed");
	}
	
	//valid signup with already registered email
			@Test(priority = 2,invocationCount = 01)
			public void stage_web_aurofit_SNATCH_SignUp_with_Already_Registed_Email() throws InterruptedException {
					
			    	test=extent.createTest("SNATCH-valid signup with already registered email");
				    test.log(Status.INFO, "SNATCH-valid signup with already registered email test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
		    ...
		    public void stage_web_aurofit_SNATCH_Login_With_Valid_Credentials() throws InterruptedException {
				
		    	test=extent.createTest("SNATCH-Valid Login");
			    test.log(Status.INFO, "SNATCH-Valid Login test script started executing");
			    Auro_Home_Page AH=new Auro_Home_Page(driver);
				AH.clickGet30DaysFreeButton();
				test.pass("clicked Get30DaysFree Button");
				//AH.clickstartFreeTrial();
		  ...
		  //Login with  valid Email and invalid Password and verify the error message
		     ...
		     public void stage_web_aurofit_SNATCH_LOGIN_VALID_EMAIL_INVALID_PASSWORD() throws InterruptedException {
				
				    test=extent.createTest("SNATCH- valid Email and invalid Password and verify the error message");
				    test.log(Status.INFO, "SNATCH- valid Email and invalid Password and verify the error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
			...
			//Login Entering Invalid Email and Valid Password and verify the error message
			    ...
			    public void stage_web_aurofit_SNATCH_LOGIN_INVALID_EMAIL__VALIDPASSWORD() throws InterruptedException {
					
					test=extent.createTest("SNATCH-Login Entering Invalid Email and Valid Password and verify the error message");
				    test.log(Status.INFO, "SNATCH-Login Entering Invalid Email and Valid Password and verify the error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
			    ...
			    public void stage_web_aurofit_SNATCH_LOGIN_UNREGISTEREDMAIL() throws InterruptedException {
					
					test=extent.createTest("SNATCH-Login Entering Unregistered Mail and check the error message");
				    test.log(Status.INFO, "SNATCH-Login Entering Unregistered Mail and check the error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_SNATCH_Dothe_Payment_Entering_Expired_Card_Credentials() throws InterruptedException {
					
					test=extent.createTest("SNATCH -Enter the Expired Card Credentials And verify \"Your card has expired.\" Error Message");
				    test.log(Status.INFO, "SNATCH -Enter the Expired Card Credentials And verify \"Your card has expired.\" Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
					...
					ACP.scrollToElementstartFreeTrialButton();
					Thread.sleep(1000);
					ACP.enterCouponCode("HOLDAPP");
					test.pass("Entered CouponCode -HOLDAPP");
					ACP.clickApplyButton();
					test.pass("Clicked Apply Button");
					ACP.verifyCouponCodeApplied();
					test.pass("Verified Coupon Code");
				...
				public void stage_web_aurofit_SNATCH_Dothe_Payment_Entering_Credentials_Incorrect_Security_Code() throws InterruptedException {
					
					test=extent.createTest("SNATCH- Enter the Card Credentials And verify \"Your card's security code is incorrect.\" Error Message");
				    test.log(Status.INFO, "SNATCH- Enter the Card Credentials And verify \"Your card's security code is incorrect.\" Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_SNATCH_Dothe_Payment_Entering_Credentials_Error_while_processing_the_card() throws InterruptedException {
					
					test=extent.createTest("SNATCH- Enter the  Card Credentials And verify \"An error occurred while processing your card. Try again in a little bit.\" Error Message while processing the Card");
				    test.log(Status.INFO, "SNATCH- Enter the  Card Credentials And verify \"An error occurred while processing your card. Try again in a little bit.\" Error Message while processing the Card test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				@Test(priority = 10,invocationCount = 01)
					public void stage_web_aurofit_SNATCH_Dothe_Payment_Entering_Credentials_Invalid_CardNumber_ErrorMessage() throws InterruptedException {
							
					test=extent.createTest("SNATCH- Enter the  Card Credentials And verify  \"Your card number is invalid.\"Error Message");
				    test.log(Status.INFO, "SNATCH- Enter the  Card Credentials And verify  \"Your card number is invalid.\"Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
          ...
          public void stage_web_aurofit_SNATCH_LoseWeight_Beginner_Spin_Availoffer_Dothe_Payment_Entering_IncompleteCardNumber_Verify_ErrorMessage() throws InterruptedException {
					
					test=extent.createTest("SNATCH- Enter incomplete card number and verify \"Your card number is incomplete.\" Error message");
				    test.log(Status.INFO, "SNATCH- Enter incomplete card number and verify \"Your card number is incomplete.\" Error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_SNATCH_Dothe_Payment_Incomplete_ExpiryDate_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("SNATCH- Enter incomplete ExpiryDate and Verify \"Your card's expiration date is incomplete.\" Error Message ");
				    test.log(Status.INFO, "SNATCH- Enter incomplete ExpiryDate and Verify \"Your card's expiration date is incomplete.\" Error Message  test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_SNATCH_LoseWeight_Beginner_Spin_Availoffer_Dothe_Payment_Incomplete_CvC_Code_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("SNATCH-Enter incomplete CvC Code and Verify \"Your card's security code is incomplete.\" Error Message ");
				    test.log(Status.INFO, "SNATCH-Enter incomplete CvC Code and Verify \"Your card's security code is incomplete.\" Error Message  test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_SNATCH_Dothe_Payment_Incomplete_ZIP_Code_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("SNATCH-Enter incomplete ZIP Code and Verify \"Your postal code is incomplete.\" Error Message");
				    test.log(Status.INFO, "SNATCH-Enter incomplete ZIP Code and Verify \"Your postal code is incomplete.\" Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_SNATCH_Dothe_Payment_Enter_DeadCardCredentials_verifyErrorMessage() throws InterruptedException {
					
					test=extent.createTest("SNATCH-Enter Dead Card and verify 'Your card's expiration year is in the past.' Error Message");
				    test.log(Status.INFO, "SNATCH-Enter Dead Card and verify 'Your card's expiration year is in the past.' Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
					AH.clickGet30DaysFreeButton();
					test.pass("clicked Get30DaysFree Button");
					//AH.clickstartFreeTrial();
				...
				public void stage_web_aurofit_SNATCH_SignUp_Enter_Invalid_CouponCode() throws InterruptedException {
						
				    	test=extent.createTest("SNATCH-Main Page Valid SignUp do the payment avail offer");
					    test.log(Status.INFO, "SNATCH-Main Page Valid SignUp do the payment avail offer valid SignUp test script started executing");
					    Auro_Home_Page AH=new Auro_Home_Page(driver);
						AH.clickGet30DaysFreeButton();
						test.pass("clicked Get30DaysFree Button");
						//AH.clickstartFreeTrial();
						...
						ACP.enterCouponCode("OFFER220");
						test.pass("Entered CouponCode -OFFER220");
						ACP.clickApplyButton();
						test.pass("Clicked Apply Button");
				...
				public void stage_web_aurofit_SNATCH__SIGNED_UP_UNSUBSCRIBED_USER() throws InterruptedException {
						
				    	test=extent.createTest("SNATCH-Login as Unsubscribed user");
					    test.log(Status.INFO, "SNATCH-Login as Unsubscribed user test script started executing");
					    Auro_Home_Page AH=new Auro_Home_Page(driver);
						AH.clickGet30DaysFreeButton();
						test.pass("clicked Get30DaysFree Button");
						//AH.clickstartFreeTrial();
						...
						String actualurl = driver.getCurrentUrl();
						System.out.println(actualurl);
						Assert.assertEquals(actualurl, "https://stage-web.auro.fit/snatch-signup/#checkout");
						test.pass("Test Script Passed");
				...
				public void stage_web_SNATCH_ForgotPassword() throws InterruptedException {
				...
				public void stage_web_aurofit_SNATCH_verify_Enter_Valid_Email_Error_Message() throws InterruptedException {
				...
				public void stage_web_aurofit_SNATCH_verify_Enter_Password_Error_Message() throws InterruptedException {
