...
import pom.Login_Page;
		...
		public class Stage_web_aurofit_CHRISTMAS_CHALLENGE extends Precondition {

			
			//valid signup avail offer checkout 
			@Test(priority = 51,invocationCount =1 )
			public void stage_web_aurofit_ChristmasChallenge_SignUp_enterCouponcode_Checkout_Subscribe() throws InterruptedException {
					
			    	test=extent.createTest("CHRISTMAS_CHALLENGE-Main Page Valid SignUp do the payment avail offer");
				    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Main Page Valid SignUp do the payment avail offer valid SignUp test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
				    AH.scrollToElementchristmasJoinTheChallenge();
				    test.pass("Scrolled to Join the Challenge Button");
				    AH.clickchristmasJoinTheChallenge();
				    test.pass("clicked Join the Challenge Button");
			...
			//valid signup with already registered email
				...
				public void stage_web_aurofit_CHRISTMAS_CHALLENGE_SignUp_with_Already_Registed_Email() throws InterruptedException {
						
				    	test=extent.createTest("CHRISTMAS_CHALLENGE-valid signup with already registered email");
					    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-valid signup with already registered email test script started executing");
					    Auro_Home_Page AH=new Auro_Home_Page(driver);
					    AH.scrollToElementchristmasJoinTheChallenge();
					    test.pass("Scrolled to Join the Challenge Button");
					    AH.clickchristmasJoinTheChallenge();
		    ...
		    @Test(priority = 50,invocationCount = 01)
		    public void stage_web_aurofit_CHRISTMAS_CHALLENGE_Login_With_Valid_Credentials() throws InterruptedException {
				
		    	test=extent.createTest("CHRISTMAS_CHALLENGE-Valid Login");
			    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Valid Login test script started executing");
			    Auro_Home_Page AH=new Auro_Home_Page(driver);
			    AH.scrollToElementchristmasJoinTheChallenge();
			    test.pass("Scrolled to Join the Challenge Button");
			    AH.clickchristmasJoinTheChallenge();
		     ...
		     public void stage_web_aurofit_CHRISTMAS_CHALLENGE_LOGIN_VALID_EMAIL_INVALID_PASSWORD() throws InterruptedException {
				
				    test=extent.createTest("CHRISTMAS_CHALLENGE-MAIN PAGE valid Email and invalid Password and verify the error message");
				    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-MAIN PAGE valid Email and invalid Password and verify the error message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
				    AH.scrollToElementchristmasJoinTheChallenge();
				    test.pass("Scrolled to Join the Challenge Button");
				    AH.clickchristmasJoinTheChallenge();
		    ...
		    public void stage_web_aurofit_CHRISTMAS_CHALLENGE_LOGIN_INVALID_EMAIL__VALIDPASSWORD() throws InterruptedException {
				
				test=extent.createTest("CHRISTMAS_CHALLENGE-Login Entering Invalid Email and Valid Password and verify the error message");
			    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Login Entering Invalid Email and Valid Password and verify the error message test script started executing");
			    Auro_Home_Page AH=new Auro_Home_Page(driver);
			    AH.scrollToElementchristmasJoinTheChallenge();
			    test.pass("Scrolled to Join the Challenge Button");
			    AH.clickchristmasJoinTheChallenge();
		    ...
		    public void stage_web_aurofit_CHRISTMAS_CHALLENGE_LOGIN_UNREGISTEREDMAIL() throws InterruptedException {
				
				test=extent.createTest("CHRISTMAS_CHALLENGE-Login Entering Unregistered Mail and check the error message");
			    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Login Entering Unregistered Mail and check the error message test script started executing");
			    Auro_Home_Page AH=new Auro_Home_Page(driver);
			    AH.scrollToElementchristmasJoinTheChallenge();
			    test.pass("Scrolled to Join the Challenge Button");
			    AH.clickchristmasJoinTheChallenge();
			 ...
			 //Enter the Expired Card Credentials And verify "Your card has expired." Error Message
				...
				public void stage_web_aurofit_CHRISTMAS_CHALLENGE_Dothe_Payment_Entering_Expired_Card_Credentials() throws InterruptedException {
					
					test=extent.createTest("CHRISTMAS_CHALLENGE-Enter the Expired Card Credentials And verify \"Your card has expired.\" Error Message");
				    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Enter the Expired Card Credentials And verify \"Your card has expired.\" Error Message test script started executing");
				    Auro_Home_Page AH=new Auro_Home_Page(driver);
				    AH.scrollToElementchristmasJoinTheChallenge();
				    test.pass("Scrolled to Join the Challenge Button");
				    AH.clickchristmasJoinTheChallenge();
					...
					Assert.assertEquals(actualurl, "https://stage-web.auro.fit/coworking-signup/thank-you");*/
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_Dothe_Payment_Entering_Credentials_Incorrect_Security_Code() throws InterruptedException {
							
							test=extent.createTest("CHRISTMAS_CHALLENGE-Enter the Card Credentials And verify \"Your card's security code is incorrect.\" Error Message");
						    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Enter the Card Credentials And verify \"Your card's security code is incorrect.\" Error Message test script started executing");
						    Auro_Home_Page AH=new Auro_Home_Page(driver);
						    AH.scrollToElementchristmasJoinTheChallenge();
						    test.pass("Scrolled to Join the Challenge Button");
						    AH.clickchristmasJoinTheChallenge();
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_Dothe_Payment_Entering_Credentials_Error_while_processing_the_card() throws InterruptedException {
							
							test=extent.createTest("CHRISTMAS_CHALLENGE-Enter the  Card Credentials And verify \"An error occurred while processing your card. Try again in a little bit.\" Error Message while processing the Card");
						    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Enter the  Card Credentials And verify \"An error occurred while processing your card. Try again in a little bit.\" Error Message while processing the Card test script started executing");
						    Auro_Home_Page AH=new Auro_Home_Page(driver);
						    AH.scrollToElementchristmasJoinTheChallenge();
						    test.pass("Scrolled to Join the Challenge Button");
						    AH.clickchristmasJoinTheChallenge();
						...
						@Test(priority = 10,invocationCount = 01)
							public void stage_web_aurofit_CHRISTMAS_CHALLENGE_Dothe_Payment_Entering_Credentials_Invalid_CardNumber_ErrorMessage() throws InterruptedException {
									
							test=extent.createTest("CHRISTMAS_CHALLENGE-Enter the  Card Credentials And verify  \"Your card number is invalid.\"Error Message");
						    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Enter the  Card Credentials And verify  \"Your card number is invalid.\"Error Message test script started executing");
						    Auro_Home_Page AH=new Auro_Home_Page(driver);
						    AH.scrollToElementchristmasJoinTheChallenge();
						    test.pass("Scrolled to Join the Challenge Button");
						    AH.clickchristmasJoinTheChallenge();
		          ...
		          public void stage_web_aurofit_CHRISTMAS_CHALLENGE_LoseWeight_Beginner_Spin_Availoffer_Dothe_Payment_Entering_IncompleteCardNumber_Verify_ErrorMessage() throws InterruptedException {
							
							test=extent.createTest("CHRISTMAS_CHALLENGE-Enter incomplete card number and verify \"Your card number is incomplete.\" Error message");
						    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Enter incomplete card number and verify \"Your card number is incomplete.\" Error message test script started executing");
						    Auro_Home_Page AH=new Auro_Home_Page(driver);
						    AH.scrollToElementchristmasJoinTheChallenge();
						    test.pass("Scrolled to Join the Challenge Button");
						    AH.clickchristmasJoinTheChallenge();
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_Dothe_Payment_Incomplete_ExpiryDate_verifyErrorMessage() throws InterruptedException {
							
							test=extent.createTest("CHRISTMAS_CHALLENGE-Enter incomplete ExpiryDate and Verify \"Your card's expiration date is incomplete.\" Error Message ");
						    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Enter incomplete ExpiryDate and Verify \"Your card's expiration date is incomplete.\" Error Message  test script started executing");
						    Auro_Home_Page AH=new Auro_Home_Page(driver);
						    AH.scrollToElementchristmasJoinTheChallenge();
						    test.pass("Scrolled to Join the Challenge Button");
						    AH.clickchristmasJoinTheChallenge();
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_LoseWeight_Beginner_Spin_Availoffer_Dothe_Payment_Incomplete_CvC_Code_verifyErrorMessage() throws InterruptedException {
							
							test=extent.createTest("CHRISTMAS_CHALLENGE-Enter incomplete CvC Code and Verify \"Your card's security code is incomplete.\" Error Message ");
						    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Enter incomplete CvC Code and Verify \"Your card's security code is incomplete.\" Error Message  test script started executing");
						    Auro_Home_Page AH=new Auro_Home_Page(driver);
						    AH.scrollToElementchristmasJoinTheChallenge();
						    test.pass("Scrolled to Join the Challenge Button");
						    AH.clickchristmasJoinTheChallenge();
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_Dothe_Payment_Incomplete_ZIP_Code_verifyErrorMessage() throws InterruptedException {
							
							test=extent.createTest("CHRISTMAS_CHALLENGE-Enter incomplete ZIP Code and Verify \"Your postal code is incomplete.\" Error Message");
						    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Enter incomplete ZIP Code and Verify \"Your postal code is incomplete.\" Error Message test script started executing");
						    Auro_Home_Page AH=new Auro_Home_Page(driver);
						    AH.scrollToElementchristmasJoinTheChallenge();
						    test.pass("Scrolled to Join the Challenge Button");
						    AH.clickchristmasJoinTheChallenge();
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_Dothe_Payment_Enter_DeadCardCredentials_verifyErrorMessage() throws InterruptedException {
							
							test=extent.createTest("CHRISTMAS_CHALLENGE-Enter Dead Card and verify 'Your card's expiration year is in the past.' Error Message");
						    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Enter Dead Card and verify 'Your card's expiration year is in the past.' Error Message test script started executing");
						    Auro_Home_Page AH=new Auro_Home_Page(driver);
						    AH.scrollToElementchristmasJoinTheChallenge();
						    test.pass("Scrolled to Join the Challenge Button");
						    AH.clickchristmasJoinTheChallenge();
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_SignUp_Enter_Invalid_CouponCode() throws InterruptedException {
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_SIGNED_UP_UNSUBSCRIBED_USER() throws InterruptedException {
								
						    	test=extent.createTest("CHRISTMAS_CHALLENGE-Login as Unsubscribed user");
							    test.log(Status.INFO, "CHRISTMAS_CHALLENGE-Login as Unsubscribed user test script started executing");
							    Auro_Home_Page AH=new Auro_Home_Page(driver);
							    AH.scrollToElementchristmasJoinTheChallenge();
							    test.pass("Scrolled to Join the Challenge Button");
							    AH.clickchristmasJoinTheChallenge();
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_ForgotPassword() throws InterruptedException {
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_verify_Enter_Valid_Email_Error_Message() throws InterruptedException {
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_verify_Enter_Password_Error_Message() throws InterruptedException {
						...
						public void stage_web_aurofit_CHRISTMAS_CHALLENGE_verify_Enter_Email_Error_Message() throws InterruptedException {
		...
		public void stage_web_aurofit_joinNow_SignUp_select_LoseWeight_Beginner_Spin_Availoffer_Dothe_Payment() throws InterruptedException {
	  ...
	  public void Stage_web_JoinNow_select_LoseWeight_Beginner_Spin_Availoffer_Dothe_Payment() throws InterruptedException {
